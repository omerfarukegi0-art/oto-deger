...
# Arka plan resmi (Yüksek kaliteli lüks araç silüeti)
...
st.markdown(f"""
    ...
    .stApp {{
        background: url("{bg_img}") no-items !important;
        background-size: cover !important;
        background-position: center !important;
        background-attachment: fixed !important;
    }}
    
    /* Karartma katmanı (Metinlerin okunması için) */
    .stApp > div:first-child {{
        background-color: rgba(255, 255, 255, 0.82) !important;
    }}

    /* Header ve diğer alanları şeffaf yap */
    ...
    .price-val {{ color: #000000 !important; font-size: 4.5rem !important; font-weight: 900 !important; }}
...
st.markdown("<p style='text-align: center; color: #FF0000 !important; font-weight: 900; font-size: 1.2rem; margin-top:-20px;'>🏁 PROFESYONEL PİYASA ANALİZİ</p>", unsafe_allow_html=True)
...
if 'data' not in st.session_state:
    ...
    if submit:
        ...
        st.markdown(f"<div class='price-box'><p style='color:#FF0000 !important; font-weight:800; margin:0;'>TAHMİNİ RAYİÇ BEDEL</p><h1 class='price-val'>{max(0, final_price):,.0f} TL</h1></div>", unsafe_allow_html=True)
