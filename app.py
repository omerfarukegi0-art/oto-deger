...
st.markdown("""
    ...
    .price-box {
        ...
        border: 4px solid #000000; text-align: center; margin: 20px 0;
...
st.markdown("<p style='text-align: center; color: #FF0000; font-weight: 900; font-size: 1.2rem; margin-top:-20px;'>🏁 HIZLI PİYASA ANALİZ SİSTEMİ</p>", unsafe_allow_html=True)
